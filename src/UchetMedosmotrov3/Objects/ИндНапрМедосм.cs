...
namespace IIS.UchetMedosmotrov3
{
    ...
    public class ИндНапрМедосм : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.UchetMedosmotrov3.Сотрудники fСотрудники;
        
        private IIS.UchetMedosmotrov3.Организация fОрганизация;
        
        private IIS.UchetMedosmotrov3.DetailArrayOfВреднФактПроиз fВреднФактПроиз;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.UchetMedosmotrov3.Организация Организация
        {
            get
            {
                ...
                IIS.UchetMedosmotrov3.Организация result = this.fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.UchetMedosmotrov3.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.UchetMedosmotrov3.Сотрудники result = this.fСотрудники;
        ...
        public virtual IIS.UchetMedosmotrov3.DetailArrayOfВреднФактПроиз ВреднФактПроиз
        {
            get
            {
                ...
                {
                    this.fВреднФактПроиз = new IIS.UchetMedosmotrov3.DetailArrayOfВреднФактПроиз(this);
                }
                IIS.UchetMedosmotrov3.DetailArrayOfВреднФактПроиз result = this.fВреднФактПроиз;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИндНапрМедосмE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИндНапрМедосмE", typeof(IIS.UchetMedosmotrov3.ИндНапрМедосм));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ИндНапрМедосмL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИндНапрМедосмL", typeof(IIS.UchetMedosmotrov3.ИндНапрМедосм));
                }
            }
        }
    }
