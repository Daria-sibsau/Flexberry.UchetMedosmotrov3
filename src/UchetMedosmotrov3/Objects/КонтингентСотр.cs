...
namespace IIS.UchetMedosmotrov3
{
    ...
    [View("КонтингентСотрE", new string[] {
            ...
            "Мужчины as \'Мужчины\'",
            "КлассВредФакт as \'Фактор производства\'",
    ...
    public class КонтингентСотр : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.UchetMedosmotrov3.Период fПериодичность;
        
        private IIS.UchetMedosmotrov3.КлассВредФакт fКлассВредФакт;
        
        private IIS.UchetMedosmotrov3.ПриказМЗР fПриказМЗР;
        
        private IIS.UchetMedosmotrov3.Подразделения fПодразделения;
        
        private IIS.UchetMedosmotrov3.СписокНаМедосм fСписокНаМедосм;
        ...
        public virtual IIS.UchetMedosmotrov3.Период Периодичность
        {
            get
            {
                ...
                IIS.UchetMedosmotrov3.Период result = this.fПериодичность;
        ...
        [PropertyStorage(new string[] {
                "Подразделения"})]
        [NotNull()]
        public virtual IIS.UchetMedosmotrov3.Подразделения Подразделения
        {
            get
            {
                ...
                IIS.UchetMedosmotrov3.Подразделения result = this.fПодразделения;
        ...
        [PropertyStorage(new string[] {
                "ПриказМЗР"})]
        [NotNull()]
        public virtual IIS.UchetMedosmotrov3.ПриказМЗР ПриказМЗР
        {
            get
            {
                ...
                IIS.UchetMedosmotrov3.ПриказМЗР result = this.fПриказМЗР;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.UchetMedosmotrov3.СписокНаМедосм.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "СписокНаМедосм"})]
        public virtual IIS.UchetMedosmotrov3.СписокНаМедосм СписокНаМедосм
        {
            get
            {
                ...
                IIS.UchetMedosmotrov3.СписокНаМедосм result = this.fСписокНаМедосм;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтингентСотрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтингентСотрE", typeof(IIS.UchetMedosmotrov3.КонтингентСотр));
                }
            }
        }
    }
    ...
    public class DetailArrayOfКонтингентСотр : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.UchetMedosmotrov3.DetailArrayOfКонтингентСотр members)

        // *** End programmer edit section *** (IIS.UchetMedosmotrov3.DetailArrayOfКонтингентСотр members)
        ...
        /// </summary>
        public DetailArrayOfКонтингентСотр(IIS.UchetMedosmotrov3.СписокНаМедосм fСписокНаМедосм) : 
                base(typeof(КонтингентСотр), ((ICSSoft.STORMNET.DataObject)(fСписокНаМедосм)))
        {
        }
        
        public IIS.UchetMedosmotrov3.КонтингентСотр this[int index]
        {
            get
            {
                return ((IIS.UchetMedosmotrov3.КонтингентСотр)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.UchetMedosmotrov3.КонтингентСотр dataobject)
        {
