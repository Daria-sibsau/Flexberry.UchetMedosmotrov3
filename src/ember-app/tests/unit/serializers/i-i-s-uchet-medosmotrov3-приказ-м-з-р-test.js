...
moduleForModel('i-i-s-uchet-medosmotrov3-приказ-м-з-р', 'Unit | Serializer | i-i-s-uchet-medosmotrov3-приказ-м-з-р', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-medosmotrov3-приказ-м-з-р',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
