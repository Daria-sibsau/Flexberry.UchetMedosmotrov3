...
moduleForModel('i-i-s-uchet-medosmotrov3-подразделения', 'Unit | Serializer | i-i-s-uchet-medosmotrov3-подразделения', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-medosmotrov3-подразделения',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
