...
moduleForModel('i-i-s-uchet-medosmotrov3-класс-вред-факт', 'Unit | Serializer | i-i-s-uchet-medosmotrov3-класс-вред-факт', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-medosmotrov3-класс-вред-факт',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
