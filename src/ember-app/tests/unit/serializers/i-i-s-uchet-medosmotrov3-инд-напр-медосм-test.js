...
moduleForModel('i-i-s-uchet-medosmotrov3-инд-напр-медосм', 'Unit | Serializer | i-i-s-uchet-medosmotrov3-инд-напр-медосм', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-medosmotrov3-инд-напр-медосм',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
